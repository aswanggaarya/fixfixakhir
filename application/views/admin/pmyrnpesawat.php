...
<head>
  ...
  <title>Admin - Pembayaran Pesawat</title>
          ...
          <li class="nav-item active">
            ...
            <div id="colpembayaran" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item active" href="<?=base_url('admin/pmyrnpesawat')?>">Pesawat</a>
              </div>
            </div>
          </li>
          ...
          <div class="row">
            ...
            <div class="col-xl-12 col-lg-8">
              ...
              <!-- Area Chart -->
                    ...
                    <table class="table" style="margin-left: -4%; width: 180vh;">
                      ...
                      <?php 
                        ...
                        <tr>
                          ...
                          <td>
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deletedatapembayaranpes<?php echo $k->idpembayaranpes ?>">Hapus</button>
                          </td>
                        </tr>
                      <?php } ?>
                    </table>
                ...
                <?php foreach($pmyrnpesawat as $k){ ?>
                  <div class="modal fade" id="deletedatapembayaranpes<?php echo $k->idpembayaranpes ?>" tabindex="-1" role="dialog" aria-labelledby="adddatapembayaranpesLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <form action="<?php echo base_url().'admin/hapuspmyrnpesawat'?>" method="post">
                            <div class="modal-body">
                                <p>Anda yakin ingin menghapus data pemesan dengan ID <b><?php echo $k->nopembayaran;?></b>?</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Kembali</button>
                                <?php echo anchor('admin/hapuspmyrnpesawat/'.$k->idpembayaranpes,'<button type="button" class="btn btn-danger">Hapus</button>'); ?>
                            </div>
                          </form>
