...
<head>
  ...
  <title>Admin - Konfirmasi Pembayaran Kereta</title>
          ...
          <li class="nav-item active">
            ...
            <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item active" href="<?=base_url('admin/pembayaranker')?>">Pembayaran Kereta</a>
              </div>
            </div>
          </li>
                    ...
                    <table class="table" style="margin-left: -4%; width: 180vh;">
                      ...
                      <?php 
                        ...
                        <tr>
                          ...
                          <td>
                            <a onclick="return confirm('Anda yakin ingin mengkonfirmasi pembayaran <?= $k->nopembayaran ?>?')" href="<?= base_url('admin/verifikasipembayaranker/'.$k->idpembayaranker); ?>" class="btn btn-success">Konfirmasi</a>
                          </td>
                        </tr>
                      <?php } ?>
                    </table>
