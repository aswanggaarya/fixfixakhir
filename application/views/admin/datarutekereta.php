...
<head>
  ...
  <title>Admin - Data Rute Kereta</title>
          ...
          <li class="nav-item active">
            ...
            <div id="colpetugas" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item active" href="<?=base_url('admin/datarutekereta')?>">Rute Kereta</a>
              ...
              <!-- Area Chart -->
                <div class="card-body">
                  <div class="chart-area">
                    ...
                    <h3>Data Rute Kereta</h3>
                    <button type="button" class="btn btn-primary" style="margin-bottom: 2%;" data-toggle="modal" data-target="#adddatakereta">Tambah Data</button>
                    <table class="table" style="margin-left: -4%; width: 180vh;">
                      ...
                      <?php 
                        ...
                        <tr>
                          ...
                          <td>
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#updatedatakereta<?php echo $k->idrutekereta ?>">Ubah</button>
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deletedatakereta<?php echo $k->idrutekereta ?>">Hapus</button>
                          </td>
                        </tr>
                      <?php } ?>
                    </table>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="adddatakeretaLabel" style="color: black;">Tambah Data Kereta</h5>
                      ...
                      <form action="<?php echo base_url(). 'admin/tambahkereta'; ?>" method="post" id="form-barang">
                        <div class="modal-body">
                          ...
                          <div class="form-group">
                            <p style="color: black; margin-bottom: -0.3%;"><b>Kereta</b></p>
                ...
                <?php foreach($datarutekereta as $k){ ?>
                  <div class="modal fade" id="deletedatakereta<?php echo $k->idrutekereta ?>" tabindex="-1" role="dialog" aria-labelledby="adddatakeretaLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="adddatakeretaLabel" style="color: black;">Hapus Data Kereta</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                          ...
                          <form action="<?php echo base_url().'admin/hapuskereta'?>" method="post">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Kembali</button>
                                <?php echo anchor('admin/hapuskereta/'.$k->idrutekereta,'<button type="button" class="btn btn-danger">Hapus</button>'); ?>
                            </div>
                          </form>
                ...
                <?php foreach($datarutekereta as $k){ ?>
                  <div class="modal fade" id="updatedatakereta<?php echo $k->idrutekereta ?>"  tabindex="-1" role="dialog" aria-labelledby="updatedatakeretaLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="updatedatakeretaLabel" style="color: black;">Ubah Data Kereta</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
