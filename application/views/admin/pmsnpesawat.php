...
<head>
  ...
  <title>Admin - Pemesanan Pesawat</title>
          ...
          <li class="nav-item active">
            ...
            <div id="colpemesanan" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item active" href="<?=base_url('admin/pmsnpesawat')?>">Pesawat</a>
              </div>
            </div>
          </li>
              ...
              <!-- Area Chart -->
                <div class="card-body">
                  <div class="chart-area">
                    ...
                    <h3 class="mb-2">Pemesanan Pesawat</h3>
                    <table class="table">
                      <thead>
                        <tr>
                          <th scope="col">No</th>
                      ...
                      <?php 
                        $no = 1;
                        foreach($datapmsnpes as $p){ 
                        ?>
                        <tr>
                          <td><?php echo $no++ ?></td>
                          <td><?php echo $p->nomortiket ?></td>
                          <td><?php echo $p->idrutepesawat ?></td>
                          <td><?php echo $p->namapemesan ?></td>
                          <td><?php echo $p->email ?></td>
                          <td><?php echo $p->alamat ?></td>
                          <td>
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deletedatapemesananpes<?php echo $p->idpemesananpes ?>">Hapus</button>
                          </td>
                        </tr>
                      <?php } ?>
                    </table>
                ...
                <!-- Modal Hapus pemesananpes -->
                <?php foreach($datapmsnpes as $p){ ?>
                  <div class="modal fade" id="deletedatapemesananpes<?php echo $p->idpemesananpes ?>" tabindex="-1" role="dialog" aria-labelledby="adddatapemesananpesLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <form action="<?php echo base_url().'admin/hapuspmsnpes'?>" method="post">
                            <div class="modal-body">
                                <p>Anda yakin ingin menghapus data pemesan dengan ID <b><?php echo $p->nomortiket;?></b>?</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Kembali</button>
                                <?php echo anchor('admin/hapuspmsnpes/'.$p->idpemesananpes,'<button type="button" class="btn btn-danger">Hapus</button>'); ?>
                            </div>
                          </form>
