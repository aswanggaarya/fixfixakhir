          ...
          <li class="nav-item active">
            ...
            <div id="colpetugas" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item active" href="<?=base_url('admin/datapetugas')?>">Petugas</a>
              ...
              <!-- Area Chart -->
                <div class="card-body">
                  <div class="chart-area">
                    ...
                    <h3>Data Petugas</h3>
                    <button type="button" class="btn btn-primary" style="margin-bottom: 2%;" data-toggle="modal" data-target="#adddatapetugas">Tambah Data</button>
                    <table class="table">
                      <thead>
                        <tr>
                          <th scope="col">No</th>
                      ...
                      <?php 
                        ...
                        <tr>
                          ...
                          <td>
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#updatedatapetugas<?php echo $p->idpetugas ?>">Ubah</button>
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deletedatapetugas<?php echo $p->idpetugas ?>">Hapus</button>
                          </td>
                        </tr>
                      <?php } ?>
                    </table>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="adddatapetugasLabel" style="color: black;">Tambah Data Pegawai</h5>
                      ...
                      <form action="<?php echo base_url(). 'admin/tambahpetugas'; ?>" method="post" id="form-barang">
                        <div class="modal-body">
                          ...
                          <div class="form-group">
                            <p style="color: black; margin-bottom: -0.3%;"><b>Nama Pegawai</b></p>
                ...
                <?php foreach($datapetugas as $p){ ?>
                  <div class="modal fade" id="deletedatapetugas<?php echo $p->idpetugas ?>" tabindex="-1" role="dialog" aria-labelledby="adddatapetugasLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="adddatapetugasLabel" style="color: black;">Hapus Data Petugas</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                          ...
                          <form action="<?php echo base_url().'admin/hapuspetugas'?>" method="post">
                            <div class="modal-body">
                                <p>Anda yakin ingin menghapus <b><?php echo $p->namapetugas;?></b>?</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Kembali</button>
                                <?php echo anchor('admin/hapuspetugas/'.$p->idpetugas,'<button type="button" class="btn btn-danger">Hapus</button>'); ?>
                            </div>
                          </form>
                ...
                <?php foreach($datapetugas as $p){ ?>
                  <div class="modal fade" id="updatedatapetugas<?php echo $p->idpetugas ?>" tabindex="-1" role="dialog" aria-labelledby="updatedatapetugasLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="updatedatapetugasLabel" style="color: black;">Ubah Data Pegawai</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
