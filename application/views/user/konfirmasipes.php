                    ...
                    <?php if ( isset($_GET['kode']) ): ?>
                      <div class="card-body">
                        <div class="card-header text-center">
                          <h5 style="margin-top: -4%;"><b>Detail Pembayaran Anda</b></h5>
                        </div>
                        <?php if($nomortiket->status === '0'): ?>
                          <h4 class="text-danger text-center mt-2 mb-2">Belum Dibayar</h4>
                        <?php elseif($nomortiket->status === '1'): ?>
                          <h4 class="text-danger text-center mt-2 mb-2">Belum dibayar</h4>
                          <p class="text-center">Tunggu Beberapa saat lagi, hingga pembayaran di konfirmasi</p><br>
                        ...
                        <!-- <p><b>Total Pembayaran Anda Adalah <?= $nomortiket->harga*penumpang ?></b></p> -->
                        <?php if($nomortiket->status === '0'): ?>
                        <p class="text-danger text-center">Mohon kirimkan bukti pembayaran anda pada kolom di bawah ini.</p>
                        <?= form_open_multipart('user/kirimkonfirmasipes'); ?>
