              ...
              <div class="card shadow mb-4">
                <div class="card-body">
                  <div class="chart-area">
                    ...
                    <form name="rute" class="" method="get" action="<?= base_url('user/listtrain') ?>">
                      <div class="row">
                        <div class="col">
                          <fieldset>
                        ...
                        <div class="col">
                          <fieldset>
                            ...
                            <div class="field input-group mb-3">
                              ...
                              <input type="date" name="date" value="" min="<?php echo date('Y-m-d') ?>" class="form-control" id="basic-url" aria-describedby="basic-addon3" required>
                            </div>
                          </fieldset>
                        </div>
                        <div class="col">
                          <fieldset>
                            ...
                            <div class="field input-group mb-3">
                              ...
                              <input type="number" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="penumpang" value="1" min="1" max="3" required>
                            </div>
                          </fieldset>
                        </div>
                      </div>
