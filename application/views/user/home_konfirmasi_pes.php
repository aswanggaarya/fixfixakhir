...
<head>
  ...
  <title>Agentiket.com - Cek Status Pembayaran Pesawat</title>
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?=base_url('user/pagekonfirmasipes');?>" style="color: grey;"><small>Status Tiket Pesawat</small></a>
            </li>
              ...
              <!-- Area Chart --> 
                ...
                <div class="card shadow mb-4">
                  <div class="card-body">
                    ...
                    <form action="<?= base_url('user/cekpembayaranpes'); ?>" method="POST">
                      <div class="form-group text-center">
                        <label class="mt-2">Kode Pembayaran</label>
                        <input type="text" name="kode" class="form-control">
                        <button class="btn btn-primary text-center mt-2">Cek Status</button>
                      </div>
