      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?=base_url('user/konfirmasiker');?>" style="color: grey;"><small>Status Tiket Kereta</small></a>
            </li>
                    ...
                    <?php if ( isset($_GET['kode']) ): ?>
                      <div class="card-body">
                        <div class="card-header text-center">
                          <h5><b>Detail Pembayaran Anda</b></h5>
                        </div>
                        <?php if($nomortiket->status === '0' || $nomortiket->status === '1'): ?>
                          <h4 class="text-danger text-center mt-2 mb-2">Belum Dibayar</h4>
                        <?php elseif($nomortiket->status === '2'): ?>
                          <h4 class="text-success text-center mt-2 mb-2">Sudah Dibayar</h4>
                        <?php endif ?>
                        <table class="table">
                          <thead>
                            <tr>
                          ...
                          <?php 
                            ...
                            <tr>
                              <td><?php echo $no++ ?></td>
                              <td><?php echo $dt->noidentitas ?></td>
                              <td><?php echo $dt->namapenumpang ?></td>
                            </tr>
                          <?php } ?>
                        </table>
                        <?php if($nomortiket->status === '0'): ?>
                        <p class="text-danger text-center">Mohon kirimkan bukti pembayaran anda pada kolom di bawah ini.</p>
                        <?= form_open_multipart('user/kirimkonfirmasiker'); ?>
                          <input type="hidden" name="nopembayaran" value="<?= $nomortiket->nopembayaran ?>">
                        ...
                        <form action="<?= base_url('user/print_kereta')?>" method="post" target="_blank">
